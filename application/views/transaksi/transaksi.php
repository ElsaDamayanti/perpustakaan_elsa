				...
				<div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <h5><a href="<?= base_url('index.php/transaksi/tambah_transaksi')?>">
                            <button class="btn btn-sm btn-info float-right" type=""><i class="fas fa_plus fa-sm">Tambah Data transaksi</i></button></a></h5>
                            </div>
                            <div>
                             <div class="card-body">
                             <div class="table-responsive">
